...
CREATE TABLE resources_per_request (
    rprId SERIAL PRIMARY KEY,
...
CREATE TABLE resources (
    ...
    FOREIGN KEY (dryid) REFERENCES dry_foods(dryid),
    FOREIGN KEY (fid) REFERENCES fuels(fid),
    FOREIGN KEY (hid) REFERENCES heavy_equipments(hid),
    FOREIGN KEY (clothid) REFERENCES clothings(clothid),
